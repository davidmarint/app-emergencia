...
class Configuration {
     ...
     * @alias module:models/Configuration
     * @param key {String} 
     * @param value {String} 
     */
    constructor(key, value) { 
        
        Configuration.initialize(this, key, value);
    }
     ...
     * @param {module:models/Configuration} obj Optional instance to populate.
     * @return {module:models/Configuration} The populated <code>Configuration</code> instance.
     */
...
Configuration.RequiredProperties = ["key", "value"];

/**
 * @member {String} key
 */
Configuration.prototype['key'] = undefined;
