...
/**
 * The PatchedEmergency model module.
 * @module models/PatchedEmergency
 * @version 1.0.0
 */
class PatchedEmergency {
    /**
     * Constructs a new <code>PatchedEmergency</code>.
     * @alias module:models/PatchedEmergency
     */
    constructor() { 
        
        PatchedEmergency.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PatchedEmergency</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/PatchedEmergency} obj Optional instance to populate.
     * @return {module:models/PatchedEmergency} The populated <code>PatchedEmergency</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchedEmergency();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchedEmergency</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchedEmergency</code>.
     */
 ...
 * @member {Number} id
 */
PatchedEmergency.prototype['id'] = undefined;

/**
 * @member {String} latitude
 */
PatchedEmergency.prototype['latitude'] = undefined;

/**
 * @member {String} longitude
 */
PatchedEmergency.prototype['longitude'] = undefined;

/**
 * @member {Date} start_time
 */
PatchedEmergency.prototype['start_time'] = undefined;

/**
 * @member {Date} finish_time
 */
PatchedEmergency.prototype['finish_time'] = undefined;

/**
 * @member {Date} register_date
 */
PatchedEmergency.prototype['register_date'] = undefined;

/**
 * @member {String} description
 */
PatchedEmergency.prototype['description'] = undefined;

/**
 * @member {Number} emergency_type
 */
PatchedEmergency.prototype['emergency_type'] = undefined;

/**
 * @member {module:models/StatusEnum} status
 */
PatchedEmergency.prototype['status'] = undefined;

/**
 * @member {Array.<module:models/ReadOnlyImages>} images
 */
PatchedEmergency.prototype['images'] = undefined;

/**
 * @member {Number} user_created_id
 */
PatchedEmergency.prototype['user_created_id'] = undefined;

/**
 * @member {Number} company
 */
PatchedEmergency.prototype['company'] = undefined;

/**
 * @member {Number} control_point
 */
PatchedEmergency.prototype['control_point'] = undefined;

/**
 * Categoría adicional definida en la compañía
 * @member {String} extra_category
 */
PatchedEmergency.prototype['extra_category'] = undefined;

/**
 * @member {String} avatar_url
 */
PatchedEmergency.prototype['avatar_url'] = undefined;
...
export default PatchedEmergency;
