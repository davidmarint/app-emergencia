...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsiApi.CompaniesApi();
  });
  ...
  describe('CompaniesApi', function() {
    ...
    describe('companiesRetrieve', function() {
      it('should call companiesRetrieve successfully', function(done) {
        //uncomment below and update the code to test companiesRetrieve
        //instance.companiesRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
