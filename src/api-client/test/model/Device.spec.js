...
(function(root, factory) {
  ...
  describe('Device', function() {
    it('should create an instance of Device', function() {
      ...
      //var instance = new AsiApi.Device();
      //expect(instance).to.be.a(AsiApi.Device);
    });
    ...
    it('should have the property deviceToken (base name: "device_token")', function() {
