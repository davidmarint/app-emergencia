...
(function(root, factory) {
  ...
  describe('GCMDevice', function() {
    it('should create an instance of GCMDevice', function() {
      // uncomment below and update the code to test GCMDevice
      //var instance = new AsiApi.GCMDevice();
      //expect(instance).to.be.a(AsiApi.GCMDevice);
    });
