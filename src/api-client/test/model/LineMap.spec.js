...
(function(root, factory) {
  ...
  describe('LineMap', function() {
    it('should create an instance of LineMap', function() {
      // uncomment below and update the code to test LineMap
      //var instance = new AsiApi.LineMap();
      //expect(instance).to.be.a(AsiApi.LineMap);
    });
