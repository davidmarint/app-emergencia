...
(function(root, factory) {
  ...
  describe('PointMap', function() {
    it('should create an instance of PointMap', function() {
      // uncomment below and update the code to test PointMap
      //var instance = new AsiApi.PointMap();
      //expect(instance).to.be.a(AsiApi.PointMap);
    });
