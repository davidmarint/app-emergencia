...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsiApi.ZoneMapProperties();
  });
  ...
  describe('ZoneMapProperties', function() {
    it('should create an instance of ZoneMapProperties', function() {
      // uncomment below and update the code to test ZoneMapProperties
      //var instance = new AsiApi.ZoneMapProperties();
      //expect(instance).to.be.a(AsiApi.ZoneMapProperties);
    });
